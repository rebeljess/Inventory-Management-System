...
public class AddProductController implements Initializable {
    ...
    @FXML
    void addProductClickSave(ActionEvent event) throws IOException {
        ...
        for (int i = 0; i < currentParts.size(); i++) {
            ...
            if (prodMin > prodMax) {
                ...
                Product newProd = new Product(prodID, prodName, prodPrice, prodInv, prodMax, prodMin);
            
                newProd.setProdID(prodID);
                newProd.setProdName(prodName);
                newProd.setProdPrice(prodPrice);
                newProd.setProdInv(prodInv);
                newProd.setProdMax(prodMax);
                newProd.setProdMin(prodMin);
